        ...
        <form action="save_book_complete.php" method="POST" enctype="multipart/form-data">
            <div class="row g-4">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="bookname" id="bookname" class="form-control bg-light border-0 p-2 shadow-none" 
                           placeholder="e.g. Madolduwa" style="border-radius: 8px;" required>
                </div>

                <div class="col-md-6">
                    <label class="form-label small fw-bold text-muted">AUTHOR NAME</label>
                    <input type="text" name="author" id="author" class="form-control bg-light border-0 p-2 shadow-none" 
                           placeholder="e.g. James Clear" style="border-radius: 8px;" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="category" id="category" class="form-select bg-light border-0 p-2 shadow-none" style="border-radius: 8px;">
                ...
                <div class="col-md-12">
                    ...
                    <div class="p-4 text-center" style="border: 2px dashed #E2E8F0; border-radius: 12px; background-color: #F8FAF9;">
                        <i class="bi bi-cloud-arrow-up fs-1" style="color: #6B8E61;"></i>
                        <input type="file" name="coverimg" id="coverimg" class="form-control mt-3 shadow-none" accept="image/*" required>
                        <p class="text-muted small mt-2 mb-0">Max file size: 2MB (JPG or PNG)</p>
                    </div>
                </div>

                <div class="col-12 mt-2 d-flex gap-2">
                    <button type="submit" name="save_book" class="btn px-4 py-2 rounded-pill shadow-sm text-white" style="background-color: #728C63; border: none;">
